# Initial Game Brief (Archive)

> Status: archived after the design was reorganized into roadmap-aligned briefs. This file preserves the original discovery research and interview record; it is not a required session read and is no longer the authoritative location for current rules.
